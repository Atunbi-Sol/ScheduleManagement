...
import Task from "../scheduleManager/Task";
import Confirm from "../confirmation/Confirm";
import "../scheduleManager/TaskManager.css";
...
const TaskManagerReducer = () => {
  ...
  const initialState = {
    ...
    isEditing: false,
    isAlertOpen: false,
    alertContent: "This is just an alert",
    alertClass: "danger",
          ...
          {state.tasks.length === 0 ? (
            ...
            <div>
              {state.tasks.map((task, index) => {
                return <Task key={index} {...task} editTask={openEditModal} deleteTask={openDeleteModal} completeTask={completeTask} />;
              })}
            </div>
          )}
        </div>

export const taskReducer = (state, action) => {
  if (action.type === "EMPTY_FIELD") {
    return {
      ...state,
      isAlertOpen: true,
      alertContent: "Please, kindly enter name and date",
      alertClass: "danger",
    };
  }
  ...
  if (action.type === "add_task") {
    ...
    return { ...state, tasks: allTasks, isAlertOpen: true, alertContent: " Task added successfully", alertClass: "success" };
  }
  ...
  if (action.type === "UPDATE_TASK") {
    // console.log("welcom", action.payload);
  ...
  if (action.type === "DELETE_TASK") {
    ...
    return {
      ...
      tasks: newTasks,
      isAlertOpen: true,
      alertContent: "Task Delete successfully",
      alertClass: "success",
